...
namespace Hollow
{
    public static class Win32
    {
        ...
        {
            internal UNICODE_STRING(IntPtr pBuffer, ushort length)
            {
                Length = length;
        ...
        public delegate NTSTATUS NtCreateUserProcess(
            ...
            PROCESS_ACCESS processDesiredAccess,
            THREAD_ACCESS threadDesiredAccess,
            IntPtr processObjectAttributes,
            IntPtr threadObjectAttributes,
            PROCESS_CREATE_FLAGS processFlags,
            THREAD_CREATE_FLAGS threadFlags,
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate NTSTATUS RtlCreateProcessParametersEx(
            ...
            IntPtr shellInfo,
            IntPtr runtimeData,
            CREATE_PROCESS_PARAMETERS_FLAGS flags
            );
